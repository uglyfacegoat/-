...
export const steps: Required<IconItem>[] = [
  {
    icon: ClipboardList,
    title: "Заявка",
    text: "Оставляете номер, примерные размеры или адрес объекта.",
  },
  {
    icon: Phone,
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Предварительно - да, фото можно отправить в мессенджер после первого контакта. Для точной сметы лучше сделать замер, потому что важны размеры, уклоны, грунт, место крепления и удобство монтажа.",
  },
];
